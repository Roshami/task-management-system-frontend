...
const AdminTaskCard = ({
  ...
  const handleEdit = () => {
    navigate(`/admin/tasks/editTask/${_id}`);
  };

  const handleView = () => {
    navigate(`/admin/tasks/viewTask/${_id}`);
  };
    ...
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-all duration-300 w-full group hover:border-violet-200">
      ...
      <div className="flex flex-row justify-between mb-4 gap-3">
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs flex flex-col sm:flex-row gap-0 sm:gap-2 text-gray-500 mt-1">{assignedTo}</p>
